...
const projects = [
  {
    ...
    description:
      "Rebuilt a conversion-led marketing site and onboarding flow for a global FinTech scale-up.",
  ...
  },
  {
    name: "HealthPlus App",
    description:
      "Designed and shipped a cross-platform care companion with offline-first support.",
    tech: ["React Native", "Node.js", "GraphQL"],
    result:
      "HIPAA-ready architecture, 60k MAUs within 3 months, crash-free sessions at 99.6%.",
    link: "https://example.com/healthplus"
  },
  {
    name: "EcoStore E-commerce",
    description:
      "Custom storefront with editorial content, shoppable stories, and growth analytics baked-in.",
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-lg text-muted-foreground">
              A sample of the products, experiences, and platforms we have
              helped craft and grow.
            </p>
          </div>
          <Link
            href="#contact"
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          {projects.map((project, index) => (
            <motion.article
              ...
              viewport={{ once: true }}
              className="group overflow-hidden rounded-2xl border-2 border-gray-600 bg-card/90 shadow-lg shadow-primary/10 transition-all hover:-translate-y-1 hover:border-primary/40 hover:shadow-xl dark:border-gray-500"
            >
              <div className="relative h-40 overflow-hidden bg-linear-to-br from-primary/20 via-accent/15 to-secondary/15">
